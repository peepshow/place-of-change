...
!function(t,e){"function"==typeof define&&define.amd?define(["ScrollMagic"],e):e("object"==typeof exports?require("scrollmagic"):t.ScrollMagic||t.jQuery&&t.jQuery.ScrollMagic)}(this,function(t){var e="0.85em",i="9999",n=15,r=t._util,o=0;t.Scene.extend(function(){var t,e=this;e.addIndicators=function(i){if(!t){var n={name:"",indent:0,parent:void 0,colorStart:"green",colorEnd:"red",colorTrigger:"blue"};i=r.extend({},n,i),o++,t=new s(e,i),e.on("add.plugin_addIndicators",t.add),e.on("remove.plugin_addIndicators",t.remove),e.on("destroy.plugin_addIndicators",e.removeIndicators),e.controller()&&t.add()}return e},e.removeIndicators=function(){return t&&(t.remove(),this.off("*.plugin_addIndicators"),t=void 0),e}}),t.Controller.addOption("addIndicators",!1),t.Controller.extend(function(){var e=this,i=e.info(),o=i.container,s=i.isDocument,a=i.vertical,l={groups:[]};this._indicators=l;var c=function(){l.updateBoundsPositions()},d=function(){l.updateTriggerGroupPositions()};return o.addEventListener("resize",d),s||(window.addEventListener("resize",d),window.addEventListener("scroll",d)),o.addEventListener("resize",c),o.addEventListener("scroll",c),this._indicators.updateBoundsPositions=function(t){for(var e,i,s,c=t?[r.extend({},t.triggerGroup,{members:[t]})]:l.groups,d=c.length,u={},h=a?"left":"top",f=a?"width":"height",p=a?r.get.scrollLeft(o)+r.get.width(o)-n:r.get.scrollTop(o)+r.get.height(o)-n;d--;)for(s=c[d],e=s.members.length,i=r.get[f](s.element.firstChild);e--;)u[h]=p-i,r.css(s.members[e].bounds,u)},this._indicators.updateTriggerGroupPositions=function(t){for(var i,c,d,u,h,f=t?[t]:l.groups,p=f.length,g=s?document.body:o,m=s?{top:0,left:0}:r.get.offset(g,!0),v=a?r.get.width(o)-n:r.get.height(o)-n,y=a?"width":"height",w=a?"Y":"X";p--;)i=f[p],c=i.element,d=i.triggerHook*e.info("size"),u=r.get[y](c.firstChild.firstChild),h=d>u?"translate"+w+"(-100%)":"",r.css(c,{top:m.top+(a?d:v-i.members[0].options.indent),left:m.left+(a?v-i.members[0].options.indent:d)}),r.css(c.firstChild.firstChild,{"-ms-transform":h,"-webkit-transform":h,transform:h})},this._indicators.updateTriggerGroupLabel=function(t){var e="trigger"+(t.members.length>1?"":" "+t.members[0].options.name),i=t.element.firstChild.firstChild,n=i.textContent!==e;n&&(i.textContent=e,a&&l.updateBoundsPositions())},this.addScene=function(i){this._options.addIndicators&&i instanceof t.Scene&&i.controller()===e&&i.addIndicators(),this.$super.addScene.apply(this,arguments)},this.destroy=function(){o.removeEventListener("resize",d),s||(window.removeEventListener("resize",d),window.removeEventListener("scroll",d)),o.removeEventListener("resize",c),o.removeEventListener("scroll",c),this.$super.destroy.apply(this,arguments)},e});var s=function(t,e){var i,n,s=this,l=a.bounds(),c=a.start(e.colorStart),d=a.end(e.colorEnd),u=e.parent&&r.get.elements(e.parent)[0];e.name=e.name||o,c.firstChild.textContent+=" "+e.name,d.textContent+=" "+e.name,l.appendChild(c),l.appendChild(d),s.options=e,s.bounds=l,s.triggerGroup=void 0,this.add=function(){n=t.controller(),i=n.info("vertical");var e=n.info("isDocument");u||(u=e?document.body:n.info("container")),e||"static"!==r.css(u,"position")||r.css(u,{position:"relative"}),t.on("change.plugin_addIndicators",f),t.on("shift.plugin_addIndicators",h),w(),m(),setTimeout(function(){n._indicators.updateBoundsPositions(s)},0)},this.remove=function(){if(s.triggerGroup){if(t.off("change.plugin_addIndicators",f),t.off("shift.plugin_addIndicators",h),s.triggerGroup.members.length>1){var e=s.triggerGroup;e.members.splice(e.members.indexOf(s),1),n._indicators.updateTriggerGroupLabel(e),n._indicators.updateTriggerGroupPositions(e),s.triggerGroup=void 0}else y();g()}};var h=function(){m()},f=function(t){"triggerHook"===t.what&&w()},p=function(){var t=n.info("vertical");r.css(c.firstChild,{"border-bottom-width":t?1:0,"border-right-width":t?0:1,bottom:t?-1:e.indent,right:t?e.indent:-1,padding:t?"0 8px":"2px 4px"}),r.css(d,{"border-top-width":t?1:0,"border-left-width":t?0:1,top:t?"100%":"",right:t?e.indent:"",bottom:t?"":e.indent,left:t?"":"100%",padding:t?"0 8px":"2px 4px"}),u.appendChild(l)},g=function(){l.parentNode.removeChild(l)},m=function(){l.parentNode!==u&&p();var e={};e[i?"top":"left"]=t.triggerPosition(),e[i?"height":"width"]=t.duration(),r.css(l,e),r.css(d,{display:t.duration()>0?"":"none"})},v=function(){var o=a.trigger(e.colorTrigger),l={};l[i?"right":"bottom"]=0,l[i?"border-top-width":"border-left-width"]=1,r.css(o.firstChild,l),r.css(o.firstChild.firstChild,{padding:i?"0 8px 3px 8px":"3px 4px"}),document.body.appendChild(o);var c={triggerHook:t.triggerHook(),element:o,members:[s]};n._indicators.groups.push(c),s.triggerGroup=c,n._indicators.updateTriggerGroupLabel(c),n._indicators.updateTriggerGroupPositions(c)},y=function(){n._indicators.groups.splice(n._indicators.groups.indexOf(s.triggerGroup),1),s.triggerGroup.element.parentNode.removeChild(s.triggerGroup.element),s.triggerGroup=void 0},w=function(){var e=t.triggerHook(),i=1e-4;if(!(s.triggerGroup&&Math.abs(s.triggerGroup.triggerHook-e)<i)){for(var r,o=n._indicators.groups,a=o.length;a--;)if(r=o[a],Math.abs(r.triggerHook-e)<i)return s.triggerGroup&&(1===s.triggerGroup.members.length?y():(s.triggerGroup.members.splice(s.triggerGroup.members.indexOf(s),1),n._indicators.updateTriggerGroupLabel(s.triggerGroup),n._indicators.updateTriggerGroupPositions(s.triggerGroup))),r.members.push(s),s.triggerGroup=r,void n._indicators.updateTriggerGroupLabel(r);if(s.triggerGroup){if(1===s.triggerGroup.members.length)return s.triggerGroup.triggerHook=e,void n._indicators.updateTriggerGroupPositions(s.triggerGroup);s.triggerGroup.members.splice(s.triggerGroup.members.indexOf(s),1),n._indicators.updateTriggerGroupLabel(s.triggerGroup),n._indicators.updateTriggerGroupPositions(s.triggerGroup),s.triggerGroup=void 0}v()}}},a={start:function(t){var e=document.createElement("div");e.textContent="start",r.css(e,{position:"absolute",overflow:"visible","border-width":0,"border-style":"solid",color:t,"border-color":t});var i=document.createElement("div");return r.css(i,{position:"absolute",overflow:"visible",width:0,height:0}),i.appendChild(e),i},end:function(t){var e=document.createElement("div");return e.textContent="end",r.css(e,{position:"absolute",overflow:"visible","border-width":0,"border-style":"solid",color:t,"border-color":t}),e},bounds:function(){var t=document.createElement("div");return r.css(t,{position:"absolute",overflow:"visible","white-space":"nowrap","pointer-events":"none","font-size":e}),t.style.zIndex=i,t},trigger:function(t){var n=document.createElement("div");n.textContent="trigger",r.css(n,{position:"relative"});var o=document.createElement("div");r.css(o,{position:"absolute",overflow:"visible","border-width":0,"border-style":"solid",color:t,"border-color":t}),o.appendChild(n);var s=document.createElement("div");return r.css(s,{position:"fixed",overflow:"visible","white-space":"nowrap","pointer-events":"none","font-size":e}),s.style.zIndex=i,s.appendChild(o),s}}}),function(t){function e(){var e=new ScrollMagic.Controller;t(".theme").each(function(){var i=TweenLite.from(this,1,{opacity:0});new ScrollMagic.Scene({triggerElement:this,triggerHook:.5,offset:0,duration:t(this).height()}).setTween(i).addTo(e)});var i=t("#bgimage").height(),n=TweenLite.to(t("#bgimage"),1,{y:"-="+i/2,ease:Linear.easeNone});new ScrollMagic.Scene({duration:2*t(document).height(),triggerElement:"body",triggerHook:.5}).setTween(n).addTo(e)}function i(){t("#theme_nav li a").click(function(e){e.preventDefault(),t(".mainMenu a").removeClass("active"),t(this).addClass("active");var i=t("#"+t(this).data("target")).offset().top;t("body, html").animate({scrollTop:i},"slow")})}function n(){var e=t(".backToTop"),i=t(window).height();e.hide();for(var n=t("#theme_nav li").children(),r=[],o=0;o<n.length;o++){console.log(n[o]);var s=n[o],a=t(s).attr("href");console.log(a),r.push(a)}t(window).scroll(function(){var n=t(window).scrollTop();n>i?e.fadeIn("slow"):e.fadeOut("slow");for(var o=t(window).height(),s=t(document).height(),a=0;a<r.length;a++){var l=r[a],c=t(l).offset().top,d=t(l).height();n>=c&&c+d>n?t("#theme_nav a[href='"+l+"']").addClass("active"):t("#theme_nav a[href='"+l+"']").removeClass("active")}if(n+o==s&&!t("#theme_nav li:last-child a").hasClass("active")){var u=t(".active").attr("href");t("#theme_nav a[href='"+u+"']").removeClass("active"),t("#theme_nav li:last-child a").addClass("active")}}),e.click(function(e){e.preventDefault(),t(" #theme_nav li a ").removeClass("active"),t(" #theme_nav li a:first ").addClass("active"),t(" body, html ").animate({scrollTop:0},"slow")})}t("#scene").parallax({relativeInput:!1,clipRelativeInput:!1,calibrationThreshold:100,calibrationDelay:500,supportDelay:500,calibrateX:!1,calibrateY:!0,invertX:!0,invertY:!0,limitX:!1,limitY:!1,scalarX:5,scalarY:5,frictionX:.1,frictionY:.1,originX:.5,originY:.5}),t("#chapter").length>0&&e(),t(document).ready(function(){function e(t){var e=null;e=document.createElement("div");var i=null;i=document.createElement("video"),i.id="video-player",i.className+="video-js vjs-polyzor-skin",i.setAttribute("preload","meta_data"),i.controls=!0;var n=document.createElement("source");n.setAttribute("src",t+".mp4"),n.setAttribute("type","video/mp4");var r=document.createElement("source");return r.setAttribute("src",t+".webm"),r.setAttribute("type","video/webm"),i.appendChild(n),i.appendChild(r),e.appendChild(i),e}var i=null;t("#video-toggler").click(function(){console.log("clicked");var n=t(this).attr("data-url");t.featherlight("#video-lightbox",{afterContent:function(i){console.log("open"),t(".featherlight-inner").append(e(n)),console.log("DOM added")},afterOpen:function(t){i=videojs("#video-player",{controls:!0,autoplay:!1,preload:"meta_data"},function(){console.log("Good to go!")})},beforeClose:function(t){i.pause(),i.dispose()}})})}),jQuery(document).ready(function(t){function e(e){var n=e.width()/2,r=e.offset().left+n,o=e.offset().top+n-t(window).scrollTop(),s=i(o,r,n,t(window).height(),t(window).width());return e.css("position","fixed").velocity({top:o-n,left:r-n,translateX:0},0),s}function i(t,e,i,n,r){var o=e>n/2?e:n-e,s=t>r/2?t:r-t;return Math.ceil(Math.sqrt(Math.pow(o,2)+Math.pow(s,2))/i)}function n(e,i,n){e.velocity({scale:i},400,function(){t("body").toggleClass("overflow-hidden",n),n?e.parents(".cd-section").addClass("modal-is-visible").end().off("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend"):e.removeClass("is-visible").removeAttr("style").siblings('[data-type="modal-trigger"]').removeClass("to-circle")})}function r(){var e=t(".cd-section.modal-is-visible").find(".cd-modal-bg"),n=e.width()/2,r=e.siblings(".btn").offset().top+n-t(window).scrollTop(),o=e.siblings(".btn").offset().left+n,s=i(r,o,n,t(window).height(),t(window).width());e.velocity({top:r-n,left:o-n,scale:s},0)}function o(){var e=t(".cd-section.modal-is-visible");e.removeClass("modal-is-visible").one("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend",function(){n(e.find(".cd-modal-bg"),1,!1)}),e.parents(".no-csstransitions").length>0&&n(e.find(".cd-modal-bg"),1,!1)}t('[data-type="modal-trigger"]').on("click",function(){var i=t(this),r=e(i.next(".cd-modal-bg"));i.addClass("to-circle"),i.next(".cd-modal-bg").addClass("is-visible").one("webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend",function(){n(i.next(".cd-modal-bg"),r,!0)}),i.parents(".no-csstransitions").length>0&&n(i.next(".cd-modal-bg"),r,!0)}),t(".cd-section .cd-modal-close").on("click",function(){o()}),t(document).keyup(function(t){"27"==t.which&&o()}),t(window).on("resize",function(){t(".cd-section.modal-is-visible").length>0&&window.requestAnimationFrame(r)})}),t(document).ready(function(){i(),n()}),t("#flat").flipster({style:"flat",buttons:!0,scrollwheel:!1,spacing:0})}(jQuery);var Modal=function(){function t(t){return document.querySelectorAll(t)}var e=t(".modal__trigger"),i=t(".modal"),n=t(".modal__bg"),r=t(".modal__content"),o=t(".modal__close"),s=window,a=!1,l=400,c=e.length,d=function(t){t.preventDefault();var e=this,i=e.dataset.modal,n=i.length,r=i.substring(1,n),o=document.getElementById(r);u(e,o)},u=function(t,e){var i=document.getElementById("modal__temp");if(null===i){var n=document.createElement("div");n.id="modal__temp",t.appendChild(n),h(t,e,n)}},h=function(t,e,i){var n,r,o,a,c=t.getBoundingClientRect(),d=e,u=d.querySelector(".modal__content").getBoundingClientRect(),h=s.innerWidth/2,p=s.innerHeight/2;t.classList.add("modal__trigger--active"),o=u.width/c.width,a=u.height/c.height,o=o.toFixed(3),a=a.toFixed(3),n=Math.round(h-c.left-c.width/2),r=Math.round(p-c.top-c.height/2),d.classList.contains("modal--align-top")&&(r=Math.round(u.height/2+u.top-c.top-c.height/2)),t.style.transform="translate("+n+"px, "+r+"px)",t.style.webkitTransform="translate("+n+"px, "+r+"px)",i.style.transform="scale("+o+","+a+")",i.style.webkitTransform="scale("+o+","+a+")",window.setTimeout(function(){window.requestAnimationFrame(function(){f(d,i)})},l)},f=function(t,e){function i(){e.style.opacity="0",n.removeEventListener("transitionend",i,!1)}if(!a){var n=t.querySelector(".modal__content");t.classList.add("modal--active"),n.classList.add("modal__content--active"),n.addEventListener("transitionend",i,!1),a=!0}},p=function(t){function n(){setTimeout(function(){window.requestAnimationFrame(function(){s.remove()})},l-50)}t.preventDefault(),t.stopImmediatePropagation();var o=t.target,s=document.getElementById("modal__temp");if(a&&o.classList.contains("modal__bg")||o.classList.contains("modal__close")){s.style.opacity="1",s.removeAttribute("style");for(var d=0;c>d;d++)i[d].classList.remove("modal--active"),r[d].classList.remove("modal__content--active"),e[d].style.transform="none",e[d].style.webkitTransform="none",e[d].classList.remove("modal__trigger--active");s.addEventListener("transitionend",n,!1),a=!1}},g=function(){for(var t=0;c>t;t++)e[t].addEventListener("click",d,!1),o[t].addEventListener("click",p,!1),n[t].addEventListener("click",p,!1)},m=function(){g()};return{init:m}}();Modal.init();